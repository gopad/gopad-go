...
/* UpdateUserPreconditionFailed describes a response with status code 412, with default header values.
...
func (o *UpdateUserPreconditionFailed) GetPayload() *models.GeneralError {
	return o.Payload
}
